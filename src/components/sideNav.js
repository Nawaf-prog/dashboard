...
const SideNav = () => {
  ...
  return (
    <div className="top-0 right-0 w-60 h-full bg-white shadow-lg rounded-l-lg z-50 p-4 flex flex-col justify-between 2k:w-[19rem] 2k:text-[20px] fullhd:w-[19rem] fullhd:text-[20px]">
      <div>
